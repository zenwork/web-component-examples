                 ...
                 <div class="results">
                    <span class="wins">0</span> wins, <span class="ties">0</span> ties, <span class="losses">0</span> losses out of <span class="out-of">0</span>
                      ...
                      lifecycle:{
                          ...
                          removed:function () {
                              console.log('rps-xtag', 'lifecycle', 'removed');
                          },
                          attributeChanged:function () {
                              console.log('rps-xtag', 'lifecycle', 'attribute changed');
                          }
                      },
                      // methods: {
                      //     someMethod: function(){
                      //         console.log('rps-xtag', 'lifecycle','some methods');
                      //     }
                      // },
                      // accessors: {
                      //     someAccessor: {
